    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('discounts.update', $discount->id) }}"  id="my-form" method="POST"
                        ...
                        <div class="row row-sm">
                            <div class="col-6">
                                <div class="form-group mg-b-0">
                                    ...
                                    <input class="form-control" name="title" placeholder="نام تخفیف" required=""
                                        type="text" value="{{ old('title', $discount->title) }}">
                                </div>
                            </div>
                            ...
                            <div class="col-6">
                                <div class="form-group mg-b-0">
                                    ...
                                    <select name="type" class="form-control SlectBox" 
                                        ...
                                        <option value="fixed" {{ $discount->type == 'fixed' ? 'selected' : '' }}>مبلغ ثابت</option>
                            ...
                            <div class="col-12" style="margin-top: 15px">
                                <div class="form-group mg-b-0">
                                    ...
                                    <input class="form-control" type="text" value="{{ old('value', $discount->value) }}" name="value" required="">
                                </div>
                            </div>
