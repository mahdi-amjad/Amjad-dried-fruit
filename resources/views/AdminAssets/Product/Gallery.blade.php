            ...
            <div class="table-responsive">
                <table class="table table-primary table-bordered mg-b-1 text-md-nowrap">
                    ...
                    <tbody>
                        ...
                        @if ($Gallery->Id_productimage==$products->id)
                        <tr>
                            <th scope="row">{{$index + 1}}</th>
                            <td>
                                <span><img src="{{asset('AdminAssets.Product-image/'.$Gallery->image)}}" width="60px" alt="avatar"></span></td>
                            <td>
                                <a href="{{route('Panel.Product.Deletegallery' , $Gallery->id )}}" class="btn btn-danger">حذف</a>
                            </td>
                      </tr>
                      @endif
                        @endforeach
