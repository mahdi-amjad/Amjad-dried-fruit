                ...
                <table class="table table-primary table-bordered mg-b-1 text-md-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span><img src="{{asset('AdminAssets.Slider-image/'.$slider->image)}}" width="60px" alt="avatar"></span></td>
                            <td>
                                <a href="{{route('Panel.Slider.Deletegallery' , $slider->id )}}" class="btn btn-danger">حذف</a>
                            </td>
                      </tr>
                        @endforeach
                    </tbody>
