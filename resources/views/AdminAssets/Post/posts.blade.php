                ...
                <table class="table table-primary table-bordered mg-b-1 text-md-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span><img src="{{asset('AdminAssets.Post-image/'.$post->image)}}" width="60px" alt="avatar"></span></td>
                            <td>
                                <a href="{{route('Panel.Post.Edit',$post->id)}}" class="btn btn-success">ویرایش</a>
                                <a href="{{route('Panel.Post.Delete',$post->id)}}" class="btn btn-danger">حذف</a>
